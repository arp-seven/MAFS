        ...
        if(isset($_POST['edit_btn']))
        {
            ...
            foreach($query_run as $row)
            {
                ?>
                    ...
                    <form action="code.php" method="POST" style="margin: 20px 20px;">
                        ...
                        <a href="profil_mhs.php" class="btn btn-danger"> Batal </a>
                        <button type="submit" name="updatebtn" class="btn btn-success"> Simpan </button>
